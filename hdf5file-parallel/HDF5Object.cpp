 ...
 * @throw std::runtime_error
 */
void HDF5File::HDF5Object::setAttribute(const std::string name, int value)
{
    //mutex.lock();
    try {
        object->removeAttr(name);
 ...
 * @throw std::runtime_error
 */
void HDF5File::HDF5Object::setAttribute(const std::string name, uint64_t value)
{
    //mutex.lock();
    try {
        object->removeAttr(name);
 ...
 * @throw std::runtime_error
 */
void HDF5File::HDF5Object::setAttribute(const std::string name, double value)
{
    //mutex.lock();
    try {
        object->removeAttr(name);
 ...
 * @throw std::runtime_error
 */
void HDF5File::HDF5Object::setAttribute(const std::string name, float value)
{
    //mutex.lock();
    try {
        object->removeAttr(name);
