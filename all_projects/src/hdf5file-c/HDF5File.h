...
public:
    #ifdef PARALLEL_HDF5
        HDF5File(std::string filename, unsigned int flag, MPI_Comm comm, MPI_Info info, bool log = false);
    #else
        HDF5File(std::string filename, unsigned int flag, bool log = false);
    #endif
