...
win32-g++:CONFIG(release, debug|release): hdf5file-c.target = $$PWD/build/hdf5file-c/release/libhdf5file-c.a
else:win32-g++:CONFIG(debug, debug|release): hdf5file-c.target = $$PWD/build/hdf5file-c/debug/libhdf5file-c.a

else:win32:!win32-g++:CONFIG(release, debug|release): hdf5file-c.target = $$PWD/build/hdf5file-c/release/hdf5file-c.lib
else:win32:!win32-g++:CONFIG(debug, debug|release): hdf5file-c.target = $$PWD/build/hdf5file-c/debug/hdf5file-c.lib

else:unix: CONFIG(release, debug|release): hdf5file-c.target = $$PWD/build/hdf5file-c/release/libhdf5file-c.a
else:unix: CONFIG(debug, debug|release): hdf5file-c.target = $$PWD/build/hdf5file-c/debug/libhdf5file-c.a
